...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { conteudo: @tarefa.conteudo, situação: @tarefa.situação, titulo: @tarefa.titulo, usuario: @tarefa.usuario } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { conteudo: @tarefa.conteudo, situação: @tarefa.situação, titulo: @tarefa.titulo, usuario: @tarefa.usuario } }
