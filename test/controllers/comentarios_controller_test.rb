...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { conteudo: @comentario.conteudo, tarefa_id: @comentario.tarefa_id, usuario: @comentario.usuario } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { conteudo: @comentario.conteudo, tarefa_id: @comentario.tarefa_id, usuario: @comentario.usuario } }
